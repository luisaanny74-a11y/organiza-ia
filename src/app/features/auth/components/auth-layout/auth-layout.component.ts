...
@Component({
  ...
  template: `
    <div
      class="min-h-screen w-full flex items-center justify-center p-6 md:p-8 bg-[#243a5f] dark:bg-black transition-colors duration-300"
    >
      <div
      ...
      >
        <button
          (click)="goBack()"
          class="absolute top-6 left-6 text-slate-400 hover:text-[#243a5f] dark:hover:text-white transition-colors cursor-pointer"
          title="Voltar"
        >
